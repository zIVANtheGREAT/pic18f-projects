...
- [`pic18f/led-walking ones-polling`](pic18f/led-walking%20-polling) — Timer0-timed LED
  chaser on the PIC18F57Q84, timing handled by polling `TMR0IF` in the
  main loop
- [`pic/led-walking ones-interrupt`](pic18f/led-walking%20ones-interrupt) — same project,
